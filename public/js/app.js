import { isFirebaseConfigured, auth } from "./firebase-init.js?v=1788798319932";
import { escapeHtml } from "./html-safety.js?v=1788798319932";
import { friendlyAuthError } from "./auth-errors.js?v=1788798319932";
import { getEffectiveTheme, toggleTheme } from "./theme.js?v=1788798319932";
import {
  watchAuthState,
  signInWithPassword,
  signOutUser,
...
import {
  ...
  isFullyLoaded,
  getClientRecord,
} from "./data.js?v=1788798319932";
import { renderCalendar } from "./calendar-view.js?v=1788798319932";
import { renderList } from "./list-view.js?v=1788798319932";
import { describeRecurrence, describeRecurrenceHistory, getLastDueOccurrence, toISODate } from "./recurrence.js?v=1788798319932";
import { colorFor, tintFor } from "./colors.js?v=1788798319932";
import { githubRepoSlug } from "./firebase-config.js?v=1788798319932";
import {
  DOC_TYPES,
  docTypeLabel,
  ...
  deleteDocument,
} from "./documents.js?v=1788798319932";
import { createClientInvite, subscribeToInviteStatus } from "./invites.js?v=1788798319932";
import { subscribeToOwnCompliance } from "./client-compliance.js?v=1788798319932";
import { subscribeToLetters, sendLetter, signLetter, deleteLetter, getLetterDownloadURL } from "./letters.js?v=1788798319932";
import {
  stampSignature,
  stampFields,

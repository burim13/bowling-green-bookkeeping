import { isFirebaseConfigured, auth } from "./firebase-init.js?v=1788798832560";
import { escapeHtml } from "./html-safety.js?v=1788798832560";
import { friendlyAuthError } from "./auth-errors.js?v=1788798832560";
import { getEffectiveTheme, toggleTheme } from "./theme.js?v=1788798832560";
import {
  watchAuthState,
  signInWithPassword,
  signOutUser,
...
import {
  ...
  isFullyLoaded,
  getClientRecord,
} from "./data.js?v=1788798832560";
import { renderCalendar } from "./calendar-view.js?v=1788798832560";
import { renderList } from "./list-view.js?v=1788798832560";
import { describeRecurrence, describeRecurrenceHistory, getLastDueOccurrence, toISODate } from "./recurrence.js?v=1788798832560";
import { colorFor, tintFor } from "./colors.js?v=1788798832560";
import { githubRepoSlug } from "./firebase-config.js?v=1788798832560";
import {
  DOC_TYPES,
  docTypeLabel,
  ...
  deleteDocument,
} from "./documents.js?v=1788798832560";
import { createClientInvite, subscribeToInviteStatus } from "./invites.js?v=1788798832560";
import { subscribeToOwnCompliance } from "./client-compliance.js?v=1788798832560";
import { subscribeToLetters, sendLetter, signLetter, deleteLetter, getLetterDownloadURL } from "./letters.js?v=1788798832560";
import {
  stampSignature,
  stampFields,
